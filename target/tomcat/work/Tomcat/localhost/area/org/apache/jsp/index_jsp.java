 ...
 * Generated at: 2019-07-13 03:25:44 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            $.get(\"province.do\",null,function (data) {\r\n");
      ...
      out.write("                $(data.info).each(function () {\r\n");
      ...
      out.write("                //先获取选中省份的省份id\r\n");
      out.write("                alert($(this).val());\r\n");
      out.write("                var id = $(this).val();\r\n");
      out.write("                //发送ajax请求，加载所有市份数据\r\n");
      out.write("                $.get(\"city.do\",{id:id},function (data) {\r\n");
      out.write("                    //[{\"id\":1,\"name\":\"北京\"},{\"id\":2,\"name\":\"上海\"},{\"id\":3,\"name\":\"广州\"},{\"id\":4,\"name\":\"陕西\"}]\r\n");
      out.write("                    //1.获取select\r\n");
      out.write("                    var city = $(\"#city\");\r\n");
      out.write("                    city.empty();\r\n");
      out.write("                    city.append(\"<option>--请选择市--</option>\");\r\n");
      out.write("                    //2.遍历json数组\r\n");
      out.write("                    $(data.info).each(function () {\r\n");
      out.write("                        //3.创建<option>\r\n");
      out.write("                        var option = \"<option value='\"+this.id+\"'>\"+this.name+\"</option>\";\r\n");
      ...
      out.write("                var id = $(this).val();\r\n");
      out.write("                //发送ajax请求，加载所有市份数据\r\n");
      out.write("                $.get(\"country.do\",{id:id},function (data) {\r\n");
      out.write("                    //[{\"id\":1,\"name\":\"北京\"},{\"id\":2,\"name\":\"上海\"},{\"id\":3,\"name\":\"广州\"},{\"id\":4,\"name\":\"陕西\"}]\r\n");
      out.write("\r\n");
      out.write("                    //1.获取select\r\n");
      out.write("                    var country = $(\"#country\");\r\n");
      out.write("                    country.empty();\r\n");
      out.write("                    //2.遍历json数组\r\n");
      out.write("                    $(data.info).each(function () {\r\n");
      out.write("                        //3.创建<option>\r\n");
      out.write("                        var option = \"<option value='\"+this.id+\"'>\"+this.name+\"</option>\";\r\n");
      out.write("\r\n");
      out.write("                        //4.调用select的append追加option\r\n");
      out.write("                        country.append(option);\r\n");
      out.write("                    });\r\n");
      out.write("\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
